...
INSERT INTO `address` VALUES (1,'Kenyatta Avenue','Nairobi',1),(2,'Herbert Macaulay Way','Lagos',2),(3,'Privet Drive','London',3);
...
INSERT INTO `author` VALUES (1,'Chimamanda Ngozi Adichie'),(2,'Ngugi wa Thiong\'o'),(3,'J.K. Rowling');
...
INSERT INTO `book` VALUES (1,'Half of a Yellow Sun',1,1),(2,'Wizard of the Crow',2,2),(3,'Harry Potter and the Philosopher\'s Stone',1,3);
...
INSERT INTO `book_language` VALUES (1,'English'),(2,'Swahili'),(3,'French');
...
INSERT INTO `country` VALUES (1,'Kenya'),(2,'Nigeria'),(3,'UK');
...
CREATE TABLE `cust_order` (
  ...
  CONSTRAINT `cust_order_ibfk_2` FOREIGN KEY (`status_id`) REFERENCES `order_status` (`status_id`),
  CONSTRAINT `cust_order_ibfk_3` FOREIGN KEY (`shipping_method_id`) REFERENCES `shipping_method` (`method_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cust_order` VALUES (1,1,1,1),(2,2,3,2);
...
INSERT INTO `customer` VALUES (1,'Kallen W.','kallen@example.com'),(2,'John Doe','john@example.com');
...
INSERT INTO `customer_address` VALUES (1,1,1),(2,2,2);
...
INSERT INTO `order_history` VALUES (1,1,1,'2025-04-12 19:35:20'),(2,1,2,'2025-04-12 19:35:20'),(3,2,3,'2025-04-12 19:35:20');
...
INSERT INTO `order_line` VALUES (1,1,1),(1,3,2),(2,2,1);
...
INSERT INTO `order_status` VALUES (1,'Pending'),(2,'Shipped'),(3,'Delivered');
...
INSERT INTO `publisher` VALUES (1,'Penguin Books'),(2,'East African Publishers'),(3,'Oxford University Press');
...
INSERT INTO `shipping_method` VALUES (1,'Courier'),(2,'Pickup'),(3,'Postal');
...
-- Dump completed on 2025-04-12 20:23:16
